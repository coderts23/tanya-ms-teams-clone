...
class TwilioRoom extends Component {
    ...
    addParticipant(participant) {
        console.log(`${participant.identity.slice(36, participant.identity.length)} has joined the room`);
        this.addParticipantToStore(participant);
        this.setState({
    ...
    removeParticipant(participant) {
        console.log(`${participant.identity.slice(36, participant.identity.length)} has left the room.`);
